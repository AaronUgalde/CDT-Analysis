...
\label{cap:modDinamico}
	...
	Este capítulo describe en modelo dinámico del sistema. en el se detallan todos los escenarios de ejecución del sistema. La figura~\ref{fig:casosDeUso} muestra el diagrama general del sistema y sus sib sistemas.
...
\input{cu/CU01-CrearMascota}
\input{cu/CU02-EliminarMascota}
\input{cu/CU03-ConsultarMisMascotas}
\input{cu/CU04-ConsultarDetalleMascota}
\input{cu/CU05-AgregarVacuna}
\input{cu/CU06-VerDocumento}
\input{cu/CU07-AgregarAlergia}
\input{cu/CU08-AgregarHistorialMedico}
\input{cu/CU09-EliminarAlergia}
\input{cu/CU10-AgregarDesparasitacion}
\input{cu/CU11-EliminarDesparasitacion}
\input{cu/CU12-AgregarDocumento}
\input{cu/CU13-EliminarDocumento}
\input{cu/CU15-CrearReservacion}
\input{cu/CU16-ConsultarReservaciones}
\input{cu/CU17-EliminarReservacion}
\input{cu/CU18-AgregarServicioReservacion}
\input{cu/CU19-EliminarServicioReservacion}
\input{cu/CU20-PagarReservacion}
\input{cu/CU21-VerDetallesReservacion}
\input{cu/CU22-VerEmpleados}
\input{cu/CU23-AgregarEmpleado}
\input{cu/CU24-EditarEmpleado}
\input{cu/CU25-EliminarEmpleado}
\input{cu/CU27-VerDetalleEmpleado}
\input{cu/CU31-VerCitasEmpleado}
