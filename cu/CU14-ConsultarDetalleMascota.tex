...
\begin{UseCase}{CU14}{Consultar Detalle de Mascota}{
	Permite al Propietario visualizar toda la información detallada de una de sus mascotas, incluyendo su perfil básico, historial médico (vacunas, enfermedades, alergias), desparasitaciones y documentos asociados.
}
	...
	\UCitem{Propósito}{Consultar de forma centralizada y completa toda la información relevante de una mascota para su correcta gestión, cuidado y pa compartirla con el personal del hotel.}
	\UCitem{Entradas}{
		\begin{itemize}
...
\begin{UCtrayectoria}{Principal}
	\UCpaso[\UCactor] Selecciona una mascota específica desde la \IUref{IU-PetList}{Lista de Mascotas}. \label{CU14-Start}
	\UCpaso El sistema navega a la \IUref{IU-PetDetail}{Pantalla de Detalle de Mascota}.
	\UCpaso Solicita al servidor toda la información asociada a la mascota seleccionada (peticiones `GET` a `/api/pets/:id`, `/api/pet-vaccinations/:`, etc.).
	...
	\UCpaso El sistema obtiene de la base de datos el perfil de la mascota y su historial médico relacionado. \Trayref{C}.
...
\begin{UCtrayectoriaA}{B}{Mascota no encontrada o no autorizada}
	\UCpaso El sistema determina que la mascota no existe (Error 404) o no pertenece al propietario (Error 403).
...
\UCExtenssionPoint{
	...
	\hyperlink{CU04}{CU04 Ver Mascota}.
}
\UCExtenssionPoint{
	% Cuando:
	...
	% Casos de uso a los que extiende:
	\hyperlink{CU06}{CU06 Agregar Vacuna}, \hyperlink{CU07}{CU07 Agregar Alergia}
}
